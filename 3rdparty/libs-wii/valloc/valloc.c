 ...
 *
 * Modified and renamed by Lameguy64/TheCodingBrony for MEM2 memory management on the Nintendo Wii
 *
...
#define __MEM_SIZE  0x033E0000	// 51.8MB
#define __MEM_START 0x90000000	// MEM2 base address
